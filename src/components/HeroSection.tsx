...
export const HeroSection: React.FC<HeroSectionProps> = ({
  ...
  return (
    <section className="relative min-h-[640px] md:min-h-[720px] lg:h-[780px] flex items-center overflow-hidden bg-[#23232D]">
      ...
      <div className="absolute inset-0 bg-gradient-to-r from-[#23232D] via-[#23232D]/90 to-[#23232D]/40 z-10 rtl:bg-gradient-to-l" />

      <div className="absolute top-1/4 end-10 w-96 h-96 bg-[#4F32CE]/20 rounded-full blur-3xl pointer-events-none" />
      <div className="absolute bottom-10 start-10 w-80 h-80 bg-[#FFC107]/10 rounded-full blur-3xl pointer-events-none" />
