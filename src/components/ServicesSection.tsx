...
import { ArrowRight, ChevronRight, Wrench, Shield, Check } from 'lucide-react';
            ...
            >
              <div>
                ...
                <div className="w-full aspect-[4/3] mb-6 overflow-hidden rounded-md bg-[#F8F9FA] relative">
                  ...
                  />
                  <div className="absolute top-3 right-3 bg-white/90 backdrop-blur-xs px-2.5 py-1 rounded font-mono-label text-xs font-medium text-[#4F32CE] border border-[#e1e3e4]">
                    {service.turnaround}
                  </div>
                </div>
              ...
              <div className="pt-4 border-t border-[#edeeef] flex items-center justify-between">
                <button
                  ...
                  className="inline-flex items-center gap-1.5 font-mono-label text-sm font-semibold text-[#4F32CE] hover:translate-x-1 transition-transform"
                >
                  Learn More
