      ...
      <div className="px-4 sm:px-8 md:px-12 max-w-[1280px] mx-auto">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          <div className="relative order-2 lg:order-1">
            ...
            <div className="absolute -bottom-6 -end-6 w-48 h-48 bg-[#4F32CE]/15 -z-10 rounded-full blur-3xl" />

            <div className="absolute -top-8 -start-8 p-6 sm:p-8 bg-white shadow-xl rounded-xl border border-[#e1e3e4] hidden lg:block z-20">
